// src/app/components/sections/Footer.js
'use client';
import { motion } from 'framer-motion';
// Placeholder for a simple logo/initial (consistent with Hero/Skills)
...
export default function Footer() {
  ...
  return (
    <motion.footer
      // Outer styling remains consistent
