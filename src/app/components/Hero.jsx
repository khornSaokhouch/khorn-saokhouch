...
export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-[90vh] px-4 sm:px-8 md:px-20 lg:px-40 flex items-center py-16 sm:py-20 md:py-24"
    >
      <div className="grid md:grid-cols-12 gap-10 w-full items-center">
        ...
        <div className="md:col-span-7 flex flex-col justify-center order-2 md:order-none">
          ...
          <motion.button
            ...
            className="mt-12 inline-block bg-accent text-background font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-full text-lg sm:text-xl transition duration-300 shadow-xl shadow-accent/50 w-fit"
          >
